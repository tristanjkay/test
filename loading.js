...
percentLoaded = (ajaxSuccess/62)*100;
        ...
        if (result.status.name == "ok") {
            ...
            console.log(result['data'][0]['currencies'][JSON.parse(localStorage.selectedCountry).iso_a3.toString()])
            ...
            selectedCountry.currency = result['data'][0]['currencies'][JSON.parse(localStorage.selectedCountry).iso_a3]['name'];
            selectedCountry.currencycode = result['data'][0]['currencies'][JSON.parse(localStorage.selectedCountry).iso_a3]['code'];
            selectedCountry.currencysymbol = result['data'][0]['currencies'][JSON.parse(localStorage.selectedCountry).iso_a3]['symbol'];
