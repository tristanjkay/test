...
setTimeout(function () {
  if(poiArray != null){
    poiArray.forEach(element => {
        $('#pois').append("<a href='s3news.html' style='text-decoration: none; color: black !important;'> <div class='greyblock' style='margin-top: 1rem; padding: 0px;'> <div class='row' style='text-align: left; padding-left: 1rem; padding-top: 1rem; padding-bottom: .5rem; padding-right: 2rem;'> <div class='col-4' style='margin-top: auto; margin-bottom: auto;'> <img src='https://maps.googleapis.com/maps/api/place/photo?maxwidth=1200&photo_reference=" + element['photos'][0]["photo_reference"] +"&key=AIzaSyBueIu23lPtas0qJpu5hjdpe4nkYE_nnoo' class='placecard' alt='' style='width:10rem; min-height: 20rem; max-height: 20rem; object-fit: cover;'> </div> <div class='col-8' style='vertical-align: middle; margin-top: 2rem; margin-bottom: 2rem;'> <h4 id='ph_placetitle'>" + element.name + "</h4><h6 id='ph_placedescription'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla suscipit sit amet justo nec vestibulum. Donec commodo mi iaculis ornare feugiat.</h6> </div> </div> </div> </a>");
      poiIndex++;
    });
  }
