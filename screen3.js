...
setTimeout(function () {
  if(flightsArray != null){
    flightsArray.forEach(element => {
        $('#flights').append('<div class="row" style="padding-top: 2rem;"><div class="col greyblock" style = "margin:1rem; margin-top:.5rem; text-align: center;"><div class="row" style="padding-top: 2rem;"><h2 style="width: auto">'+ flightsIndex +'</h2><h2 style="width: auto">'+ flightsIndex +'</h2><h2 style="width: auto">'+ flightsIndex +'</h2></div></div></div>');
      flightsIndex++;
    });
  }
